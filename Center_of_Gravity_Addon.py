...
class ARMATURE_OT_add_mass(Operator):
    ...
    bl_label = "Calculate Bone Masses"
    ...
    def execute(self, context):
       ...
       #Create the COG Empty if it does exist
        ...
        if COG_Empty is None:
            ...
            COG_Empty.empty_display_type = "SINGLE_ARROW"
            COG_Empty.empty_display_size = 0.5
            COG_Empty.show_in_front = 1

            COG_Empty.constraints.new(type="LIMIT_LOCATION")
            COG_Empty.constraints["Limit Location"].use_max_z = True
            COG_Empty.constraints["Limit Location"].use_min_z = True
       ...
       #Create the COGF Empty if it does exist and there is a root bone (The one on the floor!)
        if bpy.data.objects.get("COGF_Empty") is None:
            ...
            if root_bone != None:
                ...
                COGF_Empty.empty_display_type = "SINGLE_ARROW"
                COGF_Empty.empty_display_size = 0.5
